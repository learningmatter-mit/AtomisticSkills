...
```bash
# Env: base-agent
python .agent/skills/synthesis-recommendation/scripts/recommend_synthesis.py "LiCoO2" --limit 5 --output synthesis_recipes.json
```
...
- Calculate intercalation voltage: [intercalation-voltage](../../intercalation-voltage/SKILL.md)
- Check phase stability: [material-stability](../../material-stability/SKILL.md)
