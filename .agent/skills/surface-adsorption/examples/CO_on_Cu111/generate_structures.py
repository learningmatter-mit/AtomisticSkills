...
cu_bulk = Structure.from_file('.agent/skills/surface-adsorption/examples/CO_on_Cu111/Cu_bulk.cif')
...
# Load CO molecule
co_mol = Molecule.from_file('.agent/skills/surface-adsorption/examples/CO_on_Cu111/CO.xyz')
...
initial_struct.to(filename='.agent/skills/surface-adsorption/examples/CO_on_Cu111/CO_Cu111_initial.cif')
...
relaxed_struct.to(filename='.agent/skills/surface-adsorption/examples/CO_on_Cu111/CO_Cu111_relaxed.cif')
