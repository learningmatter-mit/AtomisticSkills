...
```bash
python .agents/skills/mat-mp2020-compatibility/scripts/check_compatibility.py --name "MACE-MH-1" --head "omat_pbe"
...
python .agents/skills/mat-mp2020-compatibility/scripts/apply_correction.py /path/to/structure_dir/
```

To run on a specific file with known energy:
```bash
# Env: base-agent
python .agents/skills/mat-mp2020-compatibility/scripts/apply_correction.py structure.cif --energy -123.45
```
